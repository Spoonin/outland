...
const RU = {
  ...
  'status.lifeSupport': 'Жизнеобеспечение',
  'status.stockpile': 'Склад',
  'status.atCap': 'у предела',
  'status.coldStart': 'Ожидание первой высадки — запасы и производство появятся после прибытия колонистов.',
  'status.years': 'лет',
  ...
  'earth.orderTotal': 'Итого заказ',
  'earth.windowSubsidy': 'Субсидия окна',
  'earth.shipMass': 'Масса к отправке',
  'earth.clearAll': 'Очистить всё',
  'earth.overBy': 'Превышение на {v}',
  'earth.goods': 'товар',
  'earth.delivery': 'доставка',
  'earth.landed': 'С доставкой',
  'earth.isDelivery': 'доставка',
  'earth.perUnitLanded': 'за ед. с доставкой',
  'earth.lineTotal': 'Строка',
  'earth.perPad': 'за площадку',
  'earth.clear': 'Сброс',
  'earth.payload': 'полезн. нагр.',
  'earth.upkeep': 'обслуж.',
  'earth.explodeRisk': 'риск взрыва',
  'earth.turnkeyBreakdown': 'структура {cost} + доставка {delivery} · {mass}, {tech}',
...
const EN: Record<keyof typeof RU, string> = {
  ...
  'status.lifeSupport': 'Life Support',
  'status.stockpile': 'Stockpile',
  'status.atCap': 'at cap',
  ...
  'earth.orderTotal': 'Order total',
  'earth.windowSubsidy': 'Window subsidy',
  'earth.shipMass': 'Ship mass',
  'earth.clearAll': 'Clear all',
  'earth.overBy': 'Over by {v}',
  'earth.goods': 'goods',
  'earth.delivery': 'delivery',
  'earth.landed': 'Landed',
  'earth.isDelivery': 'is delivery',
  'earth.perUnitLanded': 'per unit, landed',
  'earth.lineTotal': 'Line total',
  'earth.perPad': 'per pad',
  'earth.clear': 'Clear',
  'earth.payload': 'payload',
  'earth.upkeep': 'upkeep',
  'earth.explodeRisk': 'explode risk',
